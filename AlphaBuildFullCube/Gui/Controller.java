package AlphaBuildFullCube.Gui;
...
public class Controller implements Observer {
    ...
    private void extendView() {
        ...
        processImageView.setViewport(new Rectangle2D(700, 175, 600, 700)); // TODO minX und min Y (ersten Werte) abhängig von Würfelmitte machen
    }

    private void updateProcessMat() {
        // Convert the Mat to a JavaFX image and load it into the image view
        MatOfByte matOfByte = new MatOfByte();
        Imgcodecs.imencode(".jpg", model.getProcessMat(), matOfByte);
        processImageView.setImage(new Image(new ByteArrayInputStream(matOfByte.toArray())));
    }
