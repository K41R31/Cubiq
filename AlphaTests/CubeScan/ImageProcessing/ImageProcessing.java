        ...
        for (int x = 0; x < 3; x++) {
            for (int y = 0; y < 3; y++) {
                ...
                if (model.isUseMeanColor()) {
                    ...
                    //TODO aus irgendeinem Grund kommt beim Mittelstein (Bei GAN) Blau raus

                    /*
                    System.out.println("Mean " + x + ", " + y + ": " + Arrays.toString(colors[x][y].val));
                    System.out.println("Point " + x + ", " + y + ": " + new Scalar(
        ...
        for (int x = 0; x < 3; x++) {
            for (int y = 0; y < 3; y++) {
                ...
                Core.inRange(processedFrame,
                        ...
                        new Scalar(model.getGridColors()[x][y].val[0] - 15, model.getGridColors()[x][y].val[1] - 100, model.getGridColors()[x][y].val[2] - 100),
                        new Scalar(model.getGridColors()[x][y].val[0] + 15, model.getGridColors()[x][y].val[1] + 100, model.getGridColors()[x][y].val[2] + 100), processedFrame);
